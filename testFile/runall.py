...
# os.system('python HtmlTestRunner.py')
class AllTest:#定义一个类AllTest
    def __init__(self):#初始化一些参数和数据
        ...
        self.caseList = []
        print(self.caseListFile,'xx',self.caseFile)
    def set_case_list(self):
        ...
        print('case listis:',self.caseList)
        fb.close()
    ...
    def set_case_suite(self):
        ...
        for case in self.caseList:#从caselist元素组中循环取出case
            ...
            print('case file is:',self.caseFile)
            discover = unittest.defaultTestLoader.discover(r'D:\the_new_demo\testCase', pattern=case_name + '.py', top_level_dir=None)
